...
# Script to run the parallel historical message generator
# This will generate messages from March 14, 2023 to present using parallel processing
...
# Run the parallel historical message generator script
echo "Starting parallel historical message generation..."
node scripts/generateHistoricalMessagesParallel.js
